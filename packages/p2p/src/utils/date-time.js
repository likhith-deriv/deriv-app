...
export const minutesToHoursAndDays = time_in_minutes => {
    // Convert the time in minutes to days and hours
    const days = Math.floor(time_in_minutes / 1440);
    const hours = Math.floor((time_in_minutes / 60) % 24);
